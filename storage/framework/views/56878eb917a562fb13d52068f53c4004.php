...
<head>
    ...
    <title><?php echo e($heading ?? 'Author Dashboard'); ?> - IMS Author Portal</title>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between items-center py-6">
                ...
                <div class="flex items-center">
                    <a href="<?php echo e(route('author.dashboard')); ?>" class="flex items-center">
                ...
                <nav class="hidden md:flex space-x-8">
                    <a href="<?php echo e(route('author.dashboard')); ?>"
                       class="flex items-center px-3 py-2 text-sm font-medium rounded-md transition-colors duration-200
                              <?php echo e(request()->routeIs('author.dashboard') ? 'bg-blue-100 text-blue-700' : 'text-gray-600 hover:text-blue-600 hover:bg-blue-50'); ?>">
                    ...
                    <a href="<?php echo e(route('author.manuscripts')); ?>"
                       class="flex items-center px-3 py-2 text-sm font-medium rounded-md transition-colors duration-200
                              <?php echo e(request()->is('my-manuscripts*') ? 'bg-blue-100 text-blue-700' : 'text-gray-600 hover:text-blue-600 hover:bg-blue-50'); ?>">
                        <svg class="w-4 h-4 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
                        </svg>
                        My Manuscripts
                    </a>
                    <a href="<?php echo e(route('author.profile')); ?>"
                       class="flex items-center px-3 py-2 text-sm font-medium rounded-md transition-colors duration-200
                              <?php echo e(request()->is('my-profile*') ? 'bg-blue-100 text-blue-700' : 'text-gray-600 hover:text-blue-600 hover:bg-blue-50'); ?>">
                        <svg class="w-4 h-4 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <!-- Author User Menu -->
                <?php if(auth()->guard('author')->check()): ?>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
            <div class="flex flex-col md:flex-row justify-between items-center">
                <div class="text-sm text-gray-500 mb-4 md:mb-0">
                    © <?php echo e(date('Y')); ?> IMS Author Portal. All rights reserved.
                </div>
...
<?php /**PATH D:\Projects\ims-web\resources\views/components/author-layout.blade.php ENDPATH**/ ?>