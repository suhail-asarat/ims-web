    ...
    <div class="max-w-4xl mx-auto">
        ...
        <div class="bg-white rounded-lg shadow-lg p-8 mb-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6 text-center">
                <div class="p-4">
                    <div class="text-3xl font-bold text-blue-600 mb-2"><?php echo e(\App\Models\Book::count()); ?>+</div>
                    <p class="text-gray-600">Books Available</p>
                </div>
                <div class="p-4">
                    <div class="text-3xl font-bold text-blue-600 mb-2"><?php echo e(count(\App\Models\Book::genres())); ?>+</div>
                    <p class="text-gray-600">Genres Covered</p>
                </div>
                <div class="p-4">
                    <div class="text-3xl font-bold text-blue-600 mb-2"><?php echo e(count(\App\Models\Book::authors())); ?>+</div>
        ...
        <div class="bg-blue-600 rounded-lg shadow-lg p-8 text-center text-white">
            ...
            <div class="space-x-4">
                <a href="<?php echo e(url('/books')); ?>" class="inline-block bg-white text-blue-600 px-6 py-3 rounded-lg font-semibold hover:bg-blue-50 transition">
                    Browse Books
                </a>
                <a href="<?php echo e(url('/contact')); ?>" class="inline-block border-2 border-white text-white px-6 py-3 rounded-lg font-semibold hover:bg-white hover:text-blue-600 transition">
                    Contact Us
                </a>
            </div>
        </div>
...
<?php endif; ?>
<?php /**PATH D:\Projects\ims-web\resources\views/about.blade.php ENDPATH**/ ?>