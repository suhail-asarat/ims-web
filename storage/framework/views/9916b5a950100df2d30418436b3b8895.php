            ...
            <div class="flex items-start space-x-4">
                ...
                <div class="flex-1">
                    ...
                    <div class="flex items-center space-x-4 mb-4">
                        ...
                        ?>
                        <span class="inline-flex items-center px-3 py-1 rounded-full text-sm font-medium <?php echo e($statusColors[$manuscript->status] ?? 'bg-gray-100 text-gray-800'); ?>">
                            <?php echo e(ucfirst(str_replace('_', ' ', $manuscript->status))); ?>

                        </span>

                        <?php if($manuscript->pages): ?>
                            <span class="text-sm text-gray-500"><?php echo e($manuscript->pages); ?> pages</span>
                        <?php endif; ?>
                    </div>

                    <p class="text-gray-600"><?php echo e($manuscript->description); ?></p>
                </div>
            </div>
        ...
        <div class="bg-white rounded-lg shadow p-6">
            ...
            <dl class="space-y-4">
                <div>
                    ...
                    <dd class="text-sm text-gray-900 mt-1"><?php echo e($manuscript->title); ?></dd>
                </div>

                <div>
                    <dt class="text-sm font-medium text-gray-500">Genre</dt>
                    <dd class="text-sm text-gray-900 mt-1"><?php echo e($manuscript->genre); ?></dd>
                </div>

                <div>
                    <dt class="text-sm font-medium text-gray-500">Language</dt>
                    <dd class="text-sm text-gray-900 mt-1"><?php echo e($manuscript->language); ?></dd>
                </div>

                <?php if($manuscript->pages): ?>
                    <div>
                        <dt class="text-sm font-medium text-gray-500">Page Count</dt>
                        <dd class="text-sm text-gray-900 mt-1"><?php echo e($manuscript->pages); ?> pages</dd>
                    </div>
                <?php endif; ?>
                ...
                <?php if($manuscript->suggested_price): ?>
                    <div>
                        ...
                        <dd class="text-sm text-gray-900 mt-1">$<?php echo e(number_format($manuscript->suggested_price, 2)); ?></dd>
                    </div>
                <?php endif; ?>
            </dl>
        </div>
            ...
            <dl class="space-y-4">
                ...
                <?php if($manuscript->submitted_at): ?>
                    <div>
                        ...
                        <dd class="text-sm text-gray-900 mt-1"><?php echo e($manuscript->submitted_at->format('F j, Y \a\t g:i A')); ?></dd>
                    </div>
                <?php endif; ?>
                ...
                <?php if($manuscript->reviewed_at): ?>
                    <div>
                        ...
                        <dd class="text-sm text-gray-900 mt-1"><?php echo e($manuscript->reviewed_at->format('F j, Y \a\t g:i A')); ?></dd>
                    </div>
                <?php endif; ?>

                <div>
                    <dt class="text-sm font-medium text-gray-500">Last Updated</dt>
                    <dd class="text-sm text-gray-900 mt-1"><?php echo e($manuscript->updated_at->format('F j, Y \a\t g:i A')); ?></dd>
                </div>
            </dl>
        </div>
    </div>
                ...
                <div class="flex items-center">
                    ...
                    <div class="ml-4 flex-1">
                        ...
                        <?php if($manuscript->manuscript_file): ?>
                            <p class="text-sm text-gray-500"><?php echo e(basename($manuscript->manuscript_file)); ?></p>
            ...
            <div class="border border-gray-200 rounded-lg p-4">
                <div class="flex items-center">
                    ...
                    <div class="ml-4 flex-1">
                        ...
                        <?php if($manuscript->cover_image): ?>
                            <p class="text-sm text-gray-500"><?php echo e(basename($manuscript->cover_image)); ?></p>
    ...
    <div class="flex justify-between items-center">
        ...
        <?php if(in_array($manuscript->status, ['pending', 'rejected'])): ?>
            <div class="space-x-3">
                ...
                <form id="delete-form" action="<?php echo e(route('author.manuscripts.delete', $manuscript->id)); ?>" method="POST" style="display: none;">
                    <?php echo csrf_field(); ?>
...
<?php endif; ?>
<?php /**PATH D:\Projects\ims-web\resources\views/author/manuscript-detail.blade.php ENDPATH**/ ?>