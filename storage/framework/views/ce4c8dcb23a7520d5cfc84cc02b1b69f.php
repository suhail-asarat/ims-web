...
<?php $component->withAttributes([]); ?>
    ...
    <div class="bg-white rounded-lg shadow p-8">
        ...
        <form method="POST" action="<?php echo e(route('author.profile.update')); ?>" class="space-y-6">
            <?php echo csrf_field(); ?>
            ...
            <div class="border-b border-gray-200 pb-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <input
                            ...
                            name="phone"
                            class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                            value="<?php echo e(old('phone', $author->phone)); ?>"
                    ...
                    <div>
                        ...
                        <input
                            ...
                            name="website"
                            class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                            value="<?php echo e(old('website', $author->website)); ?>"
                ...
                <div class="mt-6">
                    ...
                    ><?php echo e(old('bio', $author->bio)); ?></textarea>
    ...
    <div class="mt-8 bg-blue-50 border border-blue-200 rounded-lg p-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
            <div>
                ...
                <span class="text-blue-700"><?php echo e($author->created_at->format('F j, Y')); ?></span>
            </div>
            <div>
                <span class="font-medium text-blue-800">Last Updated:</span>
                <span class="text-blue-700"><?php echo e($author->updated_at->format('F j, Y \a\t g:i A')); ?></span>
            </div>
            <div>
            ...
            <div>
                ...
                <span class="text-blue-700"><?php echo e($author->manuscripts->count()); ?></span>
            </div>
        </div>
    </div>
...
<?php endif; ?>
<?php /**PATH D:\Projects\ims-web\resources\views/author/profile.blade.php ENDPATH**/ ?>