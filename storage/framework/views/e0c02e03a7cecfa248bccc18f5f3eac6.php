...
<?php $component->withAttributes([]); ?>
        ...
        <div class="flex justify-between items-start">
            ...
            <div class="grid grid-cols-3 gap-4 text-center">
                <div class="bg-yellow-50 p-3 rounded-lg">
                    <div class="text-2xl font-bold text-yellow-600"><?php echo e($manuscripts->where('status', 'pending')->count()); ?></div>
                    <div class="text-xs text-yellow-600">Pending</div>
                </div>
                <div class="bg-blue-50 p-3 rounded-lg">
                    <div class="text-2xl font-bold text-blue-600"><?php echo e($manuscripts->where('status', 'under_review')->count()); ?></div>
                    <div class="text-xs text-blue-600">Under Review</div>
                </div>
                <div class="bg-green-50 p-3 rounded-lg">
                    <div class="text-2xl font-bold text-green-600"><?php echo e($manuscripts->where('status', 'approved')->count()); ?></div>
    ...
    <div class="mb-6 bg-white p-4 rounded-lg shadow">
        <form method="GET" action="<?php echo e(route('admin.manuscripts.index')); ?>" class="space-y-4">
            <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
                ...
                <div>
                    ...
                    <select name="sort" id="sort" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500">
                        <option value="created_at" <?php echo e(request('sort') === 'created_at' ? 'selected' : ''); ?>>Submission Date</option>
                        ...
                        <option value="reviewed_at" <?php echo e(request('sort') === 'reviewed_at' ? 'selected' : ''); ?>>Review Date</option>
                    </select>
                </div>
            </div>
            ...
            <div class="flex justify-between items-center">
                <div class="flex space-x-2">
                    ...
                    <a href="<?php echo e(route('admin.manuscripts.index')); ?>" class="px-4 py-2 bg-gray-200 text-gray-700 rounded-md hover:bg-gray-300 transition">
                        Clear Filters
                    </a>
                </div>
    ...
    <div class="mb-6">
        <div class="flex flex-wrap gap-2">
            <a href="<?php echo e(route('admin.manuscripts.index')); ?>"
               class="px-4 py-2 rounded-lg text-sm font-medium transition <?php echo e(!request('status') ? 'bg-blue-600 text-white' : 'bg-gray-200 text-gray-700 hover:bg-gray-300'); ?>">
                All (<?php echo e($manuscripts->total()); ?>)
            </a>
            <?php $__currentLoopData = $statuses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $status): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <a href="<?php echo e(route('admin.manuscripts.index', array_merge(request()->query(), ['status' => $status]))); ?>"
                   class="px-4 py-2 rounded-lg text-sm font-medium transition <?php echo e(request('status') === $status ? 'bg-blue-600 text-white' : 'bg-gray-200 text-gray-700 hover:bg-gray-300'); ?>">
                    <?php echo e(ucwords(str_replace('_', ' ', $status))); ?>
    ...
    <div class="bg-white rounded-lg shadow overflow-hidden">
        <?php if($manuscripts->count() > 0): ?>
            <form id="bulk-form" action="<?php echo e(route('admin.manuscripts.bulk-action')); ?>" method="POST">
                <?php echo csrf_field(); ?>
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            <?php $__currentLoopData = $manuscripts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $manuscript): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr class="hover:bg-gray-50">
                                    <td class="px-6 py-4">
                                        <input type="checkbox" name="manuscript_ids[]" value="<?php echo e($manuscript->id); ?>"
                                        ...
                                        <div class="flex items-start">
                                            ...
                                            <div>
                                                ...
                                                <?php if($manuscript->description): ?>
                                                    <div class="text-sm text-gray-500 mt-1"><?php echo e(Str::limit($manuscript->description, 80)); ?></div>
                                                <?php endif; ?>
                                                <?php if($manuscript->suggested_price): ?>
                                                    <div class="text-sm text-green-600 mt-1">Suggested Price: $<?php echo e(number_format($manuscript->suggested_price, 2)); ?></div>
                                                <?php endif; ?>
                                            </div>
                                        </div>
                                    </td>
                                    <td class="px-6 py-4">
                                        <div class="text-sm">
                                            <div class="font-medium text-gray-900"><?php echo e($manuscript->author->name); ?></div>
                                            <div class="text-gray-500"><?php echo e($manuscript->author->email); ?></div>
                                        </div>
                                    </td>
                                    ...
                                    <td class="px-6 py-4">
                                        ...
                                        <?php if($manuscript->reviewed_at && $manuscript->reviewer): ?>
                                            <div class="text-xs text-gray-500 mt-1">
                                                Reviewed by <?php echo e($manuscript->reviewer->name ?? 'Admin'); ?>

                                            </div>
                                        <?php endif; ?>
                                    </td>
                                    <td class="px-6 py-4 text-sm text-gray-500">
                                        <div><?php echo e($manuscript->created_at->format('M j, Y')); ?></div>
                                        <div class="text-xs"><?php echo e($manuscript->created_at->format('g:i A')); ?></div>
                                    </td>
                                    <td class="px-6 py-4 text-sm text-gray-900">
                                        <?php echo e($manuscript->pages ? number_format($manuscript->pages) : 'N/A'); ?>
...
<?php endif; ?>
<?php /**PATH D:\Projects\ims-web\resources\views/admin/manuscripts/index.blade.php ENDPATH**/ ?>