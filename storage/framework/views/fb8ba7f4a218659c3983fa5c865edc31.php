                                ...
                                <div class="flex items-center">
                                    <div class="flex-shrink-0 w-12 h-16">
                                        <?php if($book->book_cover_link): ?>
                                            <img src="<?php echo e($book->book_cover_link); ?>" alt="<?php echo e($book->book_name); ?>" class="w-12 h-16 object-cover rounded">
                                        <?php else: ?>
                                    ...
                                    <div class="ml-4">
                                        <div class="text-sm font-medium text-gray-900"><?php echo e($book->book_name); ?></div>
                                        <?php if($book->book_pages): ?>
                                            <div class="text-sm text-gray-500"><?php echo e($book->book_pages); ?> pages</div>
                                        <?php endif; ?>
                                    </div>
                                </div>
                            </td>
                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900"><?php echo e($book->book_author); ?></td>
                            <td class="px-6 py-4 whitespace-nowrap">
                                <span class="px-2 py-1 text-xs font-medium bg-blue-100 text-blue-800 rounded-full">
                                    <?php echo e($book->book_genre); ?>

                                </span>
                            </td>
                            <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900">৳<?php echo e(number_format($book->book_price, 2)); ?></td>
                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500"><?php echo e($book->book_publisher); ?></td>
                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                                <?php echo e($book->created_at ? $book->created_at->format('M d, Y') : 'N/A'); ?>

                            </td>
                            <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                <div class="flex items-center justify-end space-x-2">
                                    <?php if(Auth::guard('admin')->user()->canManageBooks()): ?>
                                        <a href="<?php echo e(route('admin.books.edit', $book->book_id)); ?>"
                                           class="text-blue-600 hover:text-blue-900 transition">
                                            <svg class="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z" />
                                            </svg>
                                        </a>
                                        <button onclick="openDeleteModal('<?php echo e($book->book_id); ?>', '<?php echo e(addslashes($book->book_name)); ?>', '<?php echo e(addslashes($book->book_author)); ?>')"
...
<?php endif; ?>
<?php /**PATH D:\Projects\ims-web\resources\views/admin/books/index.blade.php ENDPATH**/ ?>