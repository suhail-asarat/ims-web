                ...
                <?php elseif(auth()->guard('author')->check()): ?>
                    ...
                    <div class="relative" x-data="{ open: false }">
                        <button @click="open = !open" class="flex items-center px-4 py-2 rounded-full font-medium transition text-gray-700 hover:bg-blue-50 hover:text-blue-700">
                            ...
                            <span><?php echo e(Auth::guard('author')->user()->name); ?></span>
                            <svg class="w-4 h-4 ml-1" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7" />
                            </svg>
                        </button>
                        ...
                        <!-- Dropdown Menu -->
                        <div x-show="open" @click.away="open = false" x-transition class="absolute right-0 mt-2 w-48 bg-white rounded-md shadow-lg py-1 z-50">
                            <a href="<?php echo e(route('author.dashboard')); ?>" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100">
                                <svg class="w-4 h-4 inline mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 7v10a2 2 0 002 2h14a2 2 0 002-2V9a2 2 0 00-2-2H5a2 2 0 00-2-2z" />
                                </svg>
                                Dashboard
                            </a>
                            <a href="<?php echo e(route('author.manuscripts')); ?>" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100">
                                <svg class="w-4 h-4 inline mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5H7a2 2 0 00-2 2v10a2 2 0 002 2h8a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2" />
                                </svg>
                                My Manuscripts
    ...
    <main class="flex-grow max-w-7xl mx-auto py-8 px-4 w-full">
        ...
        <section class="mb-12">
            ...
            <div class="overflow-x-auto">
                <div class="flex gap-4 min-w-max">
                    ...
                    <a href="<?php echo e(url('/genre/' . urlencode($genre))); ?>" class="bg-white rounded-lg shadow p-4 flex flex-col items-center min-w-[140px] hover:shadow-lg transition-shadow">
                        <div class="bg-blue-100 rounded-full w-16 h-16 flex items-center justify-center mb-2">
                            <span class="text-2xl text-blue-700">📚</span>
                        </div>
                        <span class="font-medium text-gray-700"><?php echo e($genre); ?></span>
                    </a>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </div>
            </div>
        ...
        <section class="mb-12">
            ...
            <div class="grid grid-cols-2 sm:grid-cols-4 md:grid-cols-6 gap-4">
                ...
                <a href="<?php echo e(url('/author/' . urlencode($author))); ?>" class="bg-white rounded-lg shadow p-4 flex flex-col items-center hover:shadow-lg transition-shadow group">
        ...
        <section>
            ...
            <div class="grid grid-cols-2 sm:grid-cols-4 md:grid-cols-6 gap-4">
                ...
                <a href="<?php echo e(url('/publisher/' . urlencode($publisher))); ?>" class="bg-white rounded-lg shadow p-4 flex flex-col items-center hover:shadow-lg transition-shadow group">
...
<?php /**PATH D:\Projects\ims-web\resources\views/components/home-layout.blade.php ENDPATH**/ ?>