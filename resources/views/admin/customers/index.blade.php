        ...
        <div class="bg-white rounded-lg shadow p-4">
            <div class="flex items-center">
                ...
                <div class="ml-3">
                    ...
                    <p class="text-lg font-bold text-gray-900">{{ $customers->total() }}</p>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white rounded-lg shadow p-4">
            <div class="flex items-center">
                ...
                <div class="ml-3">
                    ...
                    <p class="text-lg font-bold text-gray-900">{{ $customers->where('is_active', true)->count() }}</p>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white rounded-lg shadow p-4">
            <div class="flex items-center">
                ...
                <div class="ml-3">
                    ...
                    <p class="text-lg font-bold text-gray-900">{{ $customers->where('is_active', false)->count() }}</p>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white rounded-lg shadow p-4">
            <div class="flex items-center">
                ...
                <div class="ml-3">
                    ...
                    <p class="text-lg font-bold text-gray-900">{{ $customers->sum('orders_count') }}</p>
                </div>
            </div>
        </div>
    </div>
                                ...
                                <div class="flex items-center">
                                    <div class="flex-shrink-0 w-10 h-10">
                                        <div class="w-10 h-10 bg-gradient-to-br from-green-400 to-green-600 rounded-full flex items-center justify-center">
                                            <span class="text-white font-medium text-sm">{{ substr($customer->name, 0, 2) }}</span>
                                        </div>
                                    </div>
                                    <div class="ml-4">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                <div class="flex items-center justify-end space-x-2">
                                    ...
                                    <form action="{{ route('admin.customers.toggle-status', $customer->id) }}" method="POST" class="inline">
                                        @csrf
                                        <button type="submit"
                                                class="{{ $customer->is_active ? 'text-yellow-600 hover:text-yellow-900' : 'text-green-600 hover:text-green-900' }} transition"
                                    ...
                                    @if($customer->orders_count == 0)
                                        <form action="{{ route('admin.customers.delete', $customer->id) }}" method="POST" class="inline"
