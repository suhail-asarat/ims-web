        ...
        <form method="POST" action="{{ route('admin.books.store') }}" class="space-y-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <input type="text" name="book_author" id="book_author" value="{{ old('book_author') }}" required
                ...
                <div>
                    ...
                    <input type="text" name="book_publisher" id="book_publisher" value="{{ old('book_publisher') }}" required
                ...
                <div>
                    ...
                    <input type="number" name="book_price" id="book_price" step="0.01" min="0" value="{{ old('book_price') }}" required
                ...
                <div>
                    ...
                    <select name="book_genre" id="book_genre" required
                        ...
                        @foreach($genres as $genre)
                            <option value="{{ $genre }}" {{ old('book_genre') === $genre ? 'selected' : '' }}>
                                {{ $genre }}
                            </option>
                        @endforeach
                    </select>
                ...
                <div>
                    ...
                    <input type="number" name="book_pages" id="book_pages" min="1" value="{{ old('book_pages') }}"
            ...
            <div>
                ...
                <input type="url" name="book_cover_link" id="book_cover_link" value="{{ old('book_cover_link') }}"
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <input type="text" name="book_isbn_10" id="book_isbn_10" value="{{ old('book_isbn_10') }}"
                ...
                <div>
                    ...
                    <input type="text" name="book_isbn_13" id="book_isbn_13" value="{{ old('book_isbn_13') }}"
            ...
            <div>
                ...
                <input type="date" name="book_publication_date" id="book_publication_date" value="{{ old('book_publication_date') }}"
